        ...
        <form>
          <Card className="shadow-lg">
            ...
            <CardFooter className="flex flex-col sm:flex-row items-center gap-2 p-6 bg-muted/30 border-t">
               {isStudentLeft ? (
                <>
                   <Button type="button" onClick={isReviewer ? () => handleReviewerAction("Re-activate Student") : handleReactivateClick} className="w-full sm:w-auto" disabled={isSaving || isDeleting || isLoadingSeats}>
                ...
                <Button type="submit" onClick={isReviewer ? () => handleReviewerAction("Save Changes") : form.handleSubmit(onSaveChanges)} className="w-full sm:w-auto" disabled={isSaveDisabled && !isReviewer}>
              ...
              <div className="w-full sm:w-auto sm:ml-auto flex flex-col sm:flex-row gap-2">
                 <AlertDialog open={isConfirmPaymentOpen} onOpenChange={setIsConfirmPaymentOpen}>
                    <AlertDialogTrigger asChild>
                        <Button
                            ...
                            onClick={() => {
                                if (isReviewer) {
                                    handleReviewerAction("Mark as Paid");
                                } else {
                ...
                <AlertDialog open={isConfirmMarkLeftOpen} onOpenChange={setIsConfirmMarkLeftOpen}>
                  ...
                  <Button
                      ...
                      onClick={() => isReviewer ? handleReviewerAction("Mark as Left") : setIsConfirmMarkLeftOpen(true)}
                  >
